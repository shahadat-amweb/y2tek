...
public class ElementUtil {
	...
	public WebElement getElement(By locator, int timeOut) {
		...
		if (Boolean.parseBoolean(DriverFactory.highlightElement)) {
			System.out.println("HIGHLIGHT:" + Boolean.parseBoolean(DriverFactory.highlightElement));
	...
	public void waitForFrameAndSwitchToItByIDOrName(int timeOut, String idOrName, int intervalTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut), Duration.ofSeconds(intervalTime));
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(idOrName));
	}
	...
	public void waitForFrameAndSwitchToItByIndex(int timeOut, int frameIndex, int intervalTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut), Duration.ofSeconds(intervalTime));
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameIndex));
	}
	...
	public void waitForFrameAndSwitchToItByFrameElement(int timeOut, WebElement frameElement, int intervalTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut), Duration.ofSeconds(intervalTime));
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameElement));
	}
	...
	public void waitForFrameAndSwitchToItByFrameLoctor(int timeOut, By frameLocator, int intervalTime) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut), Duration.ofSeconds(intervalTime));
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(frameLocator));
	}
